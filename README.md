...
&emsp;&emsp;&emsp;&emsp;Decomp progress: 89.50%

&emsp;&emsp;&emsp;&emsp;Documentation progress: 59.53%
...
```
 ...
 -------------- 89.50% Complete (90.83% NON_MATCHING) ---------------
                     # Decompiled functions: 1908
                      # GLOBAL_ASM remaining: 43
 ...
 --------------------------------------------------------------------
 We are collecting silver coins in Treasure Caves. (2/8 silver coins)
 ====================================================================
```
<!-- README_SCORE_END -->
